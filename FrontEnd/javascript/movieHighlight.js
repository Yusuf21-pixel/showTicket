...
function chechMovie() {
    ...
    let val = movieCart[movieLoc[Number(sessionStorage.getItem("lang"))][Number(sessionStorage.movieNumber)]];
    sessionStorage.setItem("mn",val[0]);
    sessionStorage.setItem("lk",val[4]);
    sessionStorage.setItem("tp",val[3]);
    sessionStorage.setItem("tm",val[6]);
    sessionStorage.setItem("rd",val[7]);
    document.getElementsByClassName("img")[0].src = val[1];
    document.getElementsByClassName("mov-name")[0].innerHTML = val[0];
    document.getElementsByClassName("lik-per")[0].innerHTML = val[4];
    document.getElementsByClassName("rat")[0].innerHTML = val[5];
    let tString = val[6] + " <i>&#9679;</i> " + val[3] + " <i>&#9679;</i> " + val[7];
    document.getElementsByClassName("tim-type")[0].innerHTML = tString;
    document.getElementsByClassName("you-vid")[0].src = val[8];
    document.getElementsByClassName("img")[0].setAttribute("alt",val[0]);
 }
